    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">MD Office Dashboard</h1>
		   <div class="row">
					...
					<th scope="col">Remark</th>
					 ...
					 <?php
					  ...
					  foreach($application_info as $application){
						  ...
						  echo '<tr><td><a href="md-office-review.php?tracking-id='.$application["tracking_id"].'">'.$application["tracking_id"].'</td><td>'.$application["submission_time"].'</td><td>'.$application["status_name"].'</td><td>'.$application["reason"].'</td><td>'.$application["remark"].'</td></tr>';
