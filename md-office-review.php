    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">MD Office Review</h1>
		   <?php 
		   
		   
		   $application_info=getApplicationInfo($tracking_id); $application=$application_info[0];
		   if($application["status_name"]=="RECOMMENDED"){
		   updateStatus($tracking_id,"APPROVAL_PENDING");
		   }
		   ?>
			<div class="row">
				...
				<form action="post-form.php" method="POST">
					 ...
					 <div class="row">
						<div class="col">
							<div class="row">
								<div class="col">
									<button type="button"  class="btn btn-success"  id="recommend" name="recommend"  >Approve</button>
								</div>
								<div class="col">
									<button type="button"  class="btn btn-danger"  id="reject" name="reject" data-toggle="modal" data-target="#reject-modal" >Disapprove</button>
								</div>
								</div>
							</div>
						<div class="col"></div>
				...
				<div class="modal" id="reject-modal" tabindex="-1" role="dialog">
					<div class="modal-dialog"  role="document">
						...
						<div class="modal-header">
							<h5 class="modal-title">Please provide disapproval reason.</h5>
...
post_fields={"operation":"update_status_md_office","tracking-id":tracking_id,"status":status}; 
...
function(postresult){
	// alert(postresult.status);
	  ...
	  if(postresult.status){
		  window.location.href="md-office-dashboard.php";
...
//return;
post_fields={"operation":"update_status_md_office","tracking-id":tracking_id,"status":status,"reason":reason,"remark":remark}; 
